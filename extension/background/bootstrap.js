(() => {
  ...
  function loadBackgroundModules() {
    safeImportScripts('background modules', [
      ...
      'background/transcripts/aiTranscriptionUploadStream.js',
      'background/transcripts/aiTranscriptionUploadHelpers.js',
      ...
      'background/transcripts/aiTranscriptionFlow.js',
