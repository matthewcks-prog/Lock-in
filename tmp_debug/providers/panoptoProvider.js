...
function extractDeliveryId(url) {
    ...
    return (_a = info === null || info === void 0 ? void 0 : info.deliveryId) !== null && _a !== void 0 ? _a : null;
}
/**
...
function extractTenantDomain(url) {
    ...
    const info = extractPanoptoInfo(url);
    if (info === null || info === void 0 ? void 0 : info.tenant)
        return info.tenant;
...
function getAnchorTitle(anchor) {
    var _a;
    return (((_a = anchor.textContent) === null || _a === void 0 ? void 0 : _a.trim()) ||
...
function detectPanoptoFromLinks(doc) {
    ...
    const addVideo = (info, title) => {
        if (seenIds.has(info.deliveryId))
            return;
    ...
    for (const anchor of anchors) {
        ...
        const wrapperUrl = wrapperCandidate ? resolveUrl(wrapperCandidate, baseUrl) || wrapperCandidate : '';
...
function detectPanoptoFromRedirect(doc) {
    ...
    for (const script of scripts) {
        ...
        const locationMatch = content.match(/(?:window\.)?location(?:\.href)?\s*=\s*['"]([^'"]*panopto[^'"]*)['"]/i);
        if (locationMatch) {
...
function resolvePanoptoEmbedUrl(video) {
    ...
    return (_a = normalizePanoptoEmbedUrl(video.embedUrl)) !== null && _a !== void 0 ? _a : video.embedUrl;
}
