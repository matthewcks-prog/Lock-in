...
function getSupabaseConfig() {
  ...
  const isLocalSupabase = devUrl && devUrl.includes('127.0.0.1');
...
const TRANSCRIPT_CHUNK_RETENTION_HOURS =
  parseInt(process.env.TRANSCRIPT_CHUNK_RETENTION_HOURS, 10) || 48;
const TRANSCRIPT_CHUNK_HARD_TTL_DAYS =
  parseInt(process.env.TRANSCRIPT_CHUNK_HARD_TTL_DAYS, 10) || 7;
const TRANSCRIPT_PROCESSING_HEARTBEAT_INTERVAL_SECONDS =
  parseInt(process.env.TRANSCRIPT_PROCESSING_HEARTBEAT_INTERVAL_SECONDS, 10) || 30;
const TRANSCRIPT_PROCESSING_STALE_MINUTES =
  parseInt(process.env.TRANSCRIPT_PROCESSING_STALE_MINUTES, 10) || 5;
