...
console.log(typeof fetchWithRetry !== 'undefined' ? '✅ fetchWithRetry exists' : '❌ fetchWithRetry missing');
...
if (typeof RETRY_CONFIG !== 'undefined') {
  ...
  if (RETRY_CONFIG.timeoutMs === 30000) {
    ...
    console.log('❌ Timeout not configured or wrong value:', RETRY_CONFIG.timeoutMs);
...
console.log('\nTest 3: Logging test');
console.log('[Lock-in] Test log message - if you see this, console logging works!');

// Test 4: Check if extractPanoptoTranscript exists
console.log('\nTest 4: extractPanoptoTranscript function check');
console.log(typeof extractPanoptoTranscript !== 'undefined' ? '✅ extractPanoptoTranscript exists' : '❌ extractPanoptoTranscript missing');
