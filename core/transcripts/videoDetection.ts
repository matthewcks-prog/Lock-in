import { extractPanoptoInfo as _extractPanoptoInfo, isPanoptoUrl as _isPanoptoUrl } from './providers/panoptoProvider';
...
export { MAX_IFRAME_DEPTH, collectIframeInfo, buildDetectionContext } from './videoDetection/context';
