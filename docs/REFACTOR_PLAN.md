...
- Create smoke test checklist document (e.g., `docs/SMOKE_CHECKLIST.md`)
- Include manual verification steps for critical extension/backend functionality
...
- [ ] **smoke checklist exists**: A smoke test checklist document exists (e.g., `docs/SMOKE_CHECKLIST.md`) with manual verification steps
